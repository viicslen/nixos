      ...
      home-manager.sharedModules = [
        {
          programs.niri.settings = {
            binds = with config.lib.niri.actions; let
              ...
              fileManager = if cfg.fileManager != null
              ...
              passwordManager = if cfg.passwordManager != null
              ...
              appBinds = lib.optionalAttrs (terminal != null) {
